...
-- Decompiled on 2025-10-24 08:04:35
-- Luau version 6, Types version 3
-- Time taken: 0.019888 seconds
...
local function IsEnabled() -- Line 1774
	--[[ Upvalues[1]:
		[1]: Updates_upvr (readonly)
	]]
	return Updates_upvr.Methods.IsEnabled("Update-10/21/2025")
end
tbl_2.IsEnabled = IsEnabled
module["Quesadillo Vampiro"] = tbl_2
local tbl = {
...
local function IsEnabled() -- Line 1786
	--[[ Upvalues[1]:
		[1]: Updates_upvr (readonly)
	]]
	return Updates_upvr.Methods.IsEnabled("Update-10/21/2025")
...
module["Burrito Bandito"] = tbl
module["Chipso and Queso"] = {
	...
	SpawnVFX = "Taco";
	SpawnDelay = 3;
	IsEnabled = function() -- Line 1798, Named "IsEnabled"
		--[[ Upvalues[1]:
			[1]: Updates_upvr (readonly)
		]]
		return Updates_upvr.Methods.IsEnabled("Update-10/21/2025")
